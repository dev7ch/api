...
CREATE TABLE `directus_activity` (
  ...
  [action_by] int check ([action_by] > 0) NOT NULL DEFAULT '0',
  [action_on] datetime2 NOT NULL,
  [ip] varchar(50) NOT NULL,
  [user_agent] varchar(255) NOT NULL,
  [collection] varchar(64) NOT NULL,
  [item] varchar(255) NOT NULL,
  [edited_on] datetime2 DEFAULT NULL,
  [comment] varchar(max),
  [comment_deleted_on] datetime2 DEFAULT NULL,
  PRIMARY KEY ([id])
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `directus_activity_seen` (
  ...
  [seen_on] datetime2 DEFAULT NULL,
  [archived] tinyint check ([archived] > 0) NOT NULL DEFAULT '0',
  PRIMARY KEY ([id])
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `directus_collection_presets` (
  ...
  [user] int check ([user] > 0) DEFAULT NULL,
  [role] int check ([role] > 0) DEFAULT NULL,
  [collection] varchar(64) NOT NULL,
  [search_query] varchar(100) DEFAULT NULL,
  [filters] varchar(max),
  [view_type] varchar(100) NOT NULL DEFAULT 'tabular',
  [view_query] varchar(max),
  [view_options] varchar(max),
  [translation] varchar(max),
  PRIMARY KEY ([id]),
  CONSTRAINT [idx_user_collection_title] UNIQUE  ([user],[collection],[title])
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `directus_collections` (
  [collection] varchar(64) NOT NULL,
  [managed] tinyint check ([managed] > 0) NOT NULL DEFAULT '1',
  [hidden] tinyint check ([hidden] > 0) NOT NULL DEFAULT '0',
  [single] tinyint check ([single] > 0) NOT NULL DEFAULT '0',
...
CREATE TABLE `directus_fields` (
  ...
  [options] varchar(max),
  [locked] tinyint check ([locked] > 0) NOT NULL DEFAULT '0',
  [validation] varchar(255) DEFAULT NULL,
  [required] tinyint check ([required] > 0) NOT NULL DEFAULT '0',
  [readonly] tinyint check ([readonly] > 0) NOT NULL DEFAULT '0',
  [hidden_detail] tinyint check ([hidden_detail] > 0) NOT NULL DEFAULT '0',
  [hidden_browse] tinyint check ([hidden_browse] > 0) NOT NULL DEFAULT '0',
  [sort] int check ([sort] > 0) DEFAULT NULL,
  [width] int check ([width] > 0) NOT NULL DEFAULT '4',
  [group] int check ([group] > 0) DEFAULT NULL,
  [note] varchar(1024) DEFAULT NULL,
  [translation] varchar(max),
  PRIMARY KEY ([id]),
  CONSTRAINT [idx_collection_field] UNIQUE  ([collection],[field])
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
VALUES
	(1, 'active', 'Admin', 'System_user', 'admin@getdirectus.com', '$2y$10$sx0.rYeNCXvJZ9LYGPZofekAq2ah7pVEWnB3YR5aNNseLBAILztc2', 'token', 'Europe/Berlin', 'en-US', '0', 1, NULL, NULL, 1, '2018-05-21 15:48:03', '/collections/projects', '00ud6pmxj4KW5F6Ua0h7'),
	(2, 'active', 'Intern', 'System_user', 'intern@getdirectus.com', NULL, 'intern_token', 'Europe/Berlin', 'en-US', '0', NULL, NULL, NULL, 1, NULL, NULL, NULL),
	(3, 'suspended', 'Disabled', 'System_user', 'disabled@getdirectus.com', '$2y$10$Njtky/bsFG9qzeW7EPy8FubOay.GxRFWTlCrQEDyR9D0N2UMdxC3u', 'disabled_token', 'America/New_York', 'en-US', '0', NULL, NULL, NULL, 1, NULL, NULL, NULL);
